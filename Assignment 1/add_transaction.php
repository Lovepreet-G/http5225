...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO transactions (date, amount, transactionType, transactionDescription,userId) VALUES ('$date', '$amount', '$transactionType', '$description',1)";
...
<body>
    ...
    <div class="container mt-4">
        ...
        (note:- Upload csv/excel file coming soon)
    </div>
